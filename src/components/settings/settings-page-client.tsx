...
type TabId = "profile" | "preferences" | "security" | "notifications" | "billing" | "appearance"

const tabs: { id: TabId; label: string; icon: React.ReactNode }[] = [
  { id: "profile", label: "Profile", icon: <UserIcon className="size-4" /> },
  { id: "preferences", label: "Preferences", icon: <SlidersHorizontalIcon className="size-4" /> },
...
function ProfileTab() {
  ...
  const [name, setName] = React.useState("Sadaqat Rao")
  const [email, setEmail] = React.useState("islamsadaqat@gmail.com")
