...
import { getContacts } from "@/services/transfers.service"
import { getRecentTransactions } from "@/services/transactions.service"
import { getCryptoCoins } from "@/services/crypto.service"
        ...
        <CommandList>
          ...
          <CommandGroup heading="Pages">
            {[
              ...
              { label: "Payable", icon: ArrowUpRightIcon, href: "/payable" },
              { label: "Receivable", icon: ArrowDownLeftIcon, href: "/receivable" },
