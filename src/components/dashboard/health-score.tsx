...
import type { HealthFactor } from "@/types/analytics"
import { getFinancialHealthScore } from "@/services/dashboard.service"
import {
  HeartPulseIcon,
  TrendingUpIcon,
  TrendingDownIcon,
...
export function HealthScore() {
  const { overall, trend, trendDelta, factors } = getFinancialHealthScore()
