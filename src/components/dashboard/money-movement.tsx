...
import { getMoneyMovementByPeriod } from "@/services/dashboard.service"
...
type Period = keyof ReturnType<typeof getMoneyMovementByPeriod>

export function MoneyMovement() {
  const moneyMovementByPeriod = getMoneyMovementByPeriod()
