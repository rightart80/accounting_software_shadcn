...
export interface ExpenseSuperCategory {
  id: string
  name: string
  shortLabel: string
  description: string
...
export const expenseSuperCategories = getExpenseCategories()

// Flatten all sub types with their parent super type info
export const allSubTypes: ExpenseSubType[] = expenseSuperCategories.flatMap((superCat) =>
...
interface ExpenseCategoryCardsProps {
...
export function ExpenseCategoryCards({
  ...
  actionSlot,
  cardsPerPage = 8,
}: ExpenseCategoryCardsProps) {
  const [page, setPage] = React.useState(0)
  const [direction, setDirection] = React.useState(0)
  
  // Custom Category State
  const [customSubTypes, setCustomSubTypes] = React.useState<ExpenseSubType[]>([])
  const [isAddOpen, setIsAddOpen] = React.useState(false)
  const [newCatName, setNewCatName] = React.useState("")
  const [newCatSuperType, setNewCatSuperType] = React.useState(selectedSuperType === "all" ? expenseSuperCategories[0].name : selectedSuperType)
  ...
  const handleAddCategory = () => {
    ...
    const newCategory: ExpenseSubType = {
      id: `custom-${Date.now()}`,
                    ...
                    <Dialog key={addBtnItem.id} open={isAddOpen} onOpenChange={setIsAddOpen}>
                      <DialogTrigger render={
                        ...
                        >
                          ...
                          <p className="mt-0.5 text-[10px] text-muted-foreground">Create new expense category</p>
                        </button>
                      } />
                      <DialogContent className="max-w-md gap-6">
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Create a new sub-category for your expense types.
                          </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-1.5">
                            <label className="text-xs font-medium">Expense Type (Super Category)</label>
